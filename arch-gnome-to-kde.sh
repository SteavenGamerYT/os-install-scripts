...
yay -Syu --noconfirm --needed plasma-wayland-session plasma-desktop maliit-keyboard konsole dolphin discover packagekit-qt5 plasma-systemmonitor partitionmanager plasma-disks sddm-git
